...
### Ressources : Boosters
Très important, cumuler des **boosters** permettra d'obtenir beaucoup plus de ressources dans un même laps de temps.
...
Si vous n'avez aucune ressource ne desespérez pas. Le plus important est de savoir qu'ils existent pour vous donner un objectif moyen-terme de les acquérir et en profiter plus tôt.
...
- **Ressources rares :** **drop des ennemis ET de caisses spéciales à casser** (utiliser frame / armes AoE + Instinct Animal si possible)
...
- **Recherche :** 
**prioriser les [invasions](https://wiki.warframe.com/w/Invasion)** sinon craft via les plans (chers, usage unique) du dojo.
  - _Ampoule de détonite_ : Piscinas, Saturne
  - _Echantillon de Fieldron_ : Kelashin, Neptune
  - _Echantillion Mutagène_ : Terrorem, Deimos
...
- **Open-world :**
  ...
  - <details><summary><b>pêche</b> (cliquer)</summary>
  
    - récupérer le [matériel de phttps://wiki.warframe.com/w/Fishing#Gear) (lances, appats) chez Hai-Luk](https://wiki.warframe.com/w/Hai-Luk) (Cetus), [Le Business](https://wiki.warframe.com/w/The_Business) (Fortuna) et la [Fille](https://wiki.warframe.com/w/Daughter) (Nécralisk)
    - équiper votre lance de pêche dans votre arsenal, roue des consommables
    - se référer à la [page wiki sur le pêche](https://wiki.warframe.com/w/Fishing) pour bien savoir les lieux et périodes pour chaque poisson. [Spots Cetus](https://wiki.warframe.com/images/Fishingmap.png?059c6) & [Spots Fortuna](https://wiki.warframe.com/images/FortunaFishingMap.jpg?636d9)
  ...
  - <details><summary><b>minage</b> (cliquer)</summary>
  ...
  - <details><summary>farm alternatif rapide / mid-game (cliquer)</summary>
...
- faire la **[sortie hebdo de Maroo](https://wiki.warframe.com/w/Maroo#Weekly_Mission)** sur Mars pour les [statues ayatan](https://wiki.warframe.com/w/Ayatan_Treasures)
   - <details><summary>détails (cliquer)</summary>
...
- **Packs de reliques :** on peut acheter chez certains syndicats des packs de 3 reliques aléatoire, très bonne source et peut être gardé pour la sortie d'une nouvelle prime
  - <details><summary>Syndicats de base (cliquer)</summary>
  ...
  - <details><summary>Syndicats open-world (cliquer)</summary>
...
- <details><summary><b>parties primes vaultées</b> (cliquer)</summary>
  ...
  - <details><summary>2 sources de reliques vaultées (cliquer)</summary>
...
- **ouvrir des reliques** : 2 types de farm
  ...
  - **farmer en groupe organisé** où chacun amène la même relique pour augmenter les chances de drop spécifiques
    ...
    -  <details><summary>passer par le canal de recrutement du jeu (cliquer)</summary>
...
- <details><summary>onglet "échanges" dans le chat du jeu (cliquer)</summary>
...
- <details><summary>mods corrompus</summary>
